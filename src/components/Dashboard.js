import {
  ...
  const Dashboard = () => {
    ...
    return (
        ...
        <div class="form-outline" style={{marginRight:'7%',position: "absolute",marginTop :'-3%'}}>
      ...
      <div className=" table table-bordered">
        ...
        <div className="status-dropdown mb-2">
          ...
          <button onClick={handleClearFilter} className="btn btn-outline-secondary float-end mt-5 mb-2" >
          Clear Filter
        </button>
